...
let greetings = `Hello ${user}. Everything is about random numbers, also your nickname. Everytime you run the program you will get a random film, character, quote, and more. Also, this message is random (joke).`
...
console.log(`Your character is: ${result}`);
...
function ironMan() {
    ...
    console.log(`One iconic quote is: ${quotes[randomIndex]}`);
}
...
console.log('Working on adding more features! Feel free to give a comment!')